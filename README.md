...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/rajavel-p
```

A live public deployment of this template is available at [https://rajavel-p.templates.workers.dev](https://rajavel-p.templates.workers.dev)
